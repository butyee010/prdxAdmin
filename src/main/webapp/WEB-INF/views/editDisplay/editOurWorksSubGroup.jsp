...
<form class="form" style="padding-top: 1rem;" action="ourWorks/submitEditOurWorksSubGroup" id="editOurWorksSubGroupForm" enctype="multipart/form-data" method="POST">
	...
	<div id="ourworksSubGroupContent"></div>
</form>

<script type="text/javascript">
	ourWorks.onLoadEditOurWorksSubGroup();
</script>